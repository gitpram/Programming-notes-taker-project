        ...
        children: <Widget>[
          Pinned.fromPins(
            ...
            child: GestureDetector(
              ...
              onTap: () => {
                launch("https://www.w3schools.com/js/")
              },
            ),
          ),//basis
          Pinned.fromPins(
            ...
            child: GestureDetector(
              ...
              onTap: () => {
                launch("https://www.w3schools.com/js/js_variables.asp")
              },
            ),
          ),//variables
          Pinned.fromPins(
            ...
            child: GestureDetector(
              ...
              onTap: () => {
                launch("https://www.w3schools.com/js/js_loop_for.asp")
              },
            ),
          ),//loops
          Pinned.fromPins(
              ...
              child: GestureDetector(
                ...
                onTap: () => {
                  launch("https://www.w3schools.com/js/js_object_methods.asp")
                },
              )
          ),//methods
          Pinned.fromPins(
              ...
              child: GestureDetector(
                ...
                onTap: () => {
                  launch("https://www.w3schools.com/js/js_operators.asp")
                },
              )
          ),//operators
          Pinned.fromPins(
            Pin(size: 179.0, start: 29.0),
            Pin(size: 61.0, end: 51.0),
            child: PageLink(
              links: [
                PageLinkInfo(
